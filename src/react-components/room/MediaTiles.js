  ...
  return (
    ...
    >
      ...
      <div className={styles.tileActions}>
        {entry.type === "avatar" && (
          <TileAction
            title={intl.formatMessage({ id: "media-tile.action.edit-avatar", defaultMessage: "Редактировать аватар" })}
            onClick={onEdit}
          >
            <PenIcon />
          </TileAction>
        ...
        {entry.type === "scene" && entry.project_id && (
          <TileAction
            onClick={onEdit}
            title={intl.formatMessage({ id: "media-tile.action.edit-scene", defaultMessage: "Редактирование сцены" })}
          >
            <PenIcon />
          </TileAction>
        )}
        {entry.type === "avatar_listing" && (
          <TileAction
            title={intl.formatMessage({
              ...
              defaultMessage: "Показать похожие аватары"
            })}
        ...
        {entry.type === "avatar_listing" && entry.allow_remixing && (
          <TileAction
            title={intl.formatMessage({
              ...
              defaultMessage: "Скопировать на свои аватары"
            })}
            onClick={onCopy}
          >
            <DuplicateIcon />
        ...
        {entry.type === "scene_listing" && entry.allow_remixing && (
          <TileAction
            title={intl.formatMessage({
              ...
              defaultMessage: "Копирование в мои сцены"
            })}
            onClick={onCopy}
          >
            <DuplicateIcon />
        ...
        {entry.type === "room" && onInfo && entry.description && (
          <TileAction
            title={intl.formatMessage({
              ...
              defaultMessage: "Информация о номере"
            })}
            onClick={onInfo}
          >
            <HelpIcon />
